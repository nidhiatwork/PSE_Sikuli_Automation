...
if len(sys.argv)>1:
    ...
    workbook = xlrd.open_workbook(Constants.PSE_Test_Execution_Data)
...
runner = HTMLTestRunner.HTMLTestRunner(stream=outfile, title='PSE UI Tests Execution Report', verbosity=3, dirTestScreenshots=Constants.ScreenshotsFolder, description='This is test report for test execution of UI tests for Photoshop Elements application.' )
runner.run(suite)